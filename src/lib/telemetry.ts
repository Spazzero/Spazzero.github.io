 ...
 * it is the same measurement for everyone. The offset belongs to the place of
 * birth, not to the reader, and is set in `src/data/profile.json`.
 */
...
/** Year of first sustained computer use. See `src/data/about.ts`. */
