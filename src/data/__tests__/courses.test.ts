...
describe('courses data', () => {
  ...
  // `number` and `link` are optional, because coursework is often published by
  // name only. They still have to be well-formed when they are present.
  it('course numbers are non-empty when present', () => {
    for (const course of courses) {
