...
export default function AboutContent({ markdown }: AboutContentProps) {
  ...
  return (
    <article className="about-content">
      ...
      {/* A jump list is only a shortcut when there is somewhere to jump past.
          With a single section it duplicates the heading directly below it, so
          the nav appears once the page has more than one. */}
      {sections.length > 1 ? (
